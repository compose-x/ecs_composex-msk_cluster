...
To install msk_cluster, run this command in your terminal:
...
The sources for msk_cluster can be downloaded from the `Github repo`_.
...
.. _tarball: https://github.com/compose-x/ecs_composex_msk_cluster/tarball/master
